            ...
            stage('Code Checkout') {
                ...
                stage('Build and Deploy') {
                    steps {
                        ...
                        sh "mvn -s $Maven_Settings package deploy -Dusername=$env.DEVOPSUSERNAME -Dpassword=$env.DEVOPSPASSWORD -Denv=dev -DmuleDeploy -Denvironment=Dev -DskipTests=true -DbuildNumber=${env.BUILD_NUMBER}"
                                                                                                     }
